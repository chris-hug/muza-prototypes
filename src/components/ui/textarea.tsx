 ...
 */
const FIELD_CLS =
  "flex field-sizing-content min-h-16 w-full rounded-lg border border-border hover:border-foreground/30 bg-background px-4 py-2 text-small font-normal transition-colors outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-ring disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive invalid-ring dark:aria-invalid:border-destructive/50"
